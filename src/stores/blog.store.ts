...
export class BlogStore {
  ...
  public articlesContainerStore: ArticlesContainerStore = new ArticlesContainerStore(this.apiService)
  public userSessionStore: UserSessionStore = new UserSessionStore(this.apiService, this.tokenService)
